    ...
    <div className=" relative max-w-full mt-20 h-auto flex flex-col text-left items-center ">
      ...
      >
        {projects.map((project) => (
          <div className="w-screen flex-shrink-0 flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen bg-slate-900">
            <motion.img
              initial={{
                y: -300,
                opacity: 0,
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              <h4 className="text-4xl font-semibold text-center">
                <span className="underline decoration-[#003788]/50">
                  Case study
                </span>
              </h4>
              <p className="text-ls text-center md:text-left">
                project summary: lorem ipsum about Netflix and another code
                based project from ai chatgpt, i wordked with javascript html
                and scss with stepzen in mind
              </p>
            </div>
          </div>
        ))}
